...
from backend.app.ai.prompts import WEEKLY_REVIEW_SYSTEM, build_weekly_review_prompt
...
def weekly_review(db: Session) -> WeeklyReviewResponse:
    ...
    recommendation, ai_generated = _weekly_recommendation(db, stats)
...
def _weekly_recommendation(db: Session, stats: dict) -> tuple[str, bool]:
    """
...
def personal_calibration(db: Session) -> list[dict]:
    ...
    """
    from backend.app.ml import calibration as calibration_module
