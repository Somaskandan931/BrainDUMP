...
from backend.app.ai import embeddings, episodic_memory, long_term_memory, semantic_memory
from backend.app.ai.memory import working_memory
from backend.app.ai.ollama_client import OllamaError, call_model
from backend.app.ai.prompts import EXECUTION_COACH_SYSTEM, build_execution_coach_prompt
from backend.app.services.ai.usage_service import AIUsageLimitExceeded
from backend.app.models.enums import TaskStatus
from backend.app.models.task import Task
from backend.app.services.planning import deadline_service, scheduler_service, task_parser
...
def _handle_fallback(db: Session, message: str) -> CoachResponse:
    ...
    except (OllamaError, AIUsageLimitExceeded) as exc:
