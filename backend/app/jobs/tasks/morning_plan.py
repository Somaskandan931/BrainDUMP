...
from backend.app.ai.prompts import DAILY_PLANNER_SYSTEM, build_daily_planner_prompt
...
from backend.app.services.productivity import notification_service
...
def _daily_narration(db, plan: dict) -> tuple[str, bool]:
    """
...
def _run_morning_job_for_user(db) -> dict:
    ...
    narration, narration_ai_generated = _daily_narration(db, narration_input)
