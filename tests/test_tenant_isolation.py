...
from backend.schemas.user_settings import UserSettingsUpdate
from backend.services import schedule_service, scheduler_service, user_settings_service
...
def test_nightly_job_writes_a_metric_row_and_summary_per_user(db, other_db, user, other_user):
    from backend.scheduler import nightly
