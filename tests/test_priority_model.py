...
from backend.ml.priority_model import compute_priority_components, compute_priority_score
...
def test_same_project_follow_up_has_no_switch_cost(db):
    from backend.ml.priority_model import compute_context_switch_cost
